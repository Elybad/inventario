		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				...
				<label for="user_name" class="col-sm-3 control-label">¿Nombre de una mascota preferida?</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" id="Oname_pet" name="Oname_pet" placeholder="Verificar usuario" required>
				</div>
			  </div>
