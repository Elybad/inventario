		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  <div class="form-group">
				<label for="codigo" class="col-sm-3 control-label">Folio</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Armazon</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="categoria" class="col-sm-3 control-label">Cliente</label>
				<div class="col-sm-8">
