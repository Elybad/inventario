		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				<label for="user_name" class="col-sm-3 control-label">¿Nombre de una mascota?</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" id="name_pet" name="name_pet" placeholder="Verificar usuario" required>
				</div>
			  </div>
