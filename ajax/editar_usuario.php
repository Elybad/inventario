...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname2'])){
        ...
        } elseif (empty($_POST['Oname_pet'])){
			$errors[] = "Nombre de mascota vacio.";
		} elseif (
          ...
          )
         {
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $name_pet = mysqli_real_escape_string($con,(strip_tags($_POST["Oname_pet"],ENT_QUOTES)));
				$user_id=intval($_POST['mod_id']);
					
               
					// actualizar usuario
                    $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email."', pet='".$name_pet."'
