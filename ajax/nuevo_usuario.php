...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			$errors[] = "Nesesitamos el campo de verificar contraseña.";
		} elseif (
			...
			//escapar, además de eliminar todo lo que podría ser código (html / javascript-) 
                ...
                $name_pet = mysqli_real_escape_string($con,(strip_tags($_POST['name_pet'],ENT_QUOTES)));
                ...
                // checa si ya hay un email registrado 
                ...
                if ($query_check_user == 1) {
					...
					// insert un nuevo usuario a la database 
                    $sql = "INSERT INTO users (firstname, lastname, user_name, user_password_hash, user_email, date_added, pet)
                            VALUES('".$firstname."','".$lastname."','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','".$date_added."','".$name_pet."');";
