...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `date_added` datetime NOT NULL,
  `pet` varchar(20) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `users` (`user_id`, `firstname`, `lastname`, `user_name`, `user_password_hash`, `user_email`, `date_added`,`pet`) VALUES
(1, 'Pepe', 'Gomez', 'ybad', '$2y$10$MPVHzZ2ZPOWmtUUGCq3RXu31OTB.jo7M9LZ7PmPQYmgETSNn19ejO', 'ybad34@gmail.com', '2016-12-19 15:06:00','woody');
